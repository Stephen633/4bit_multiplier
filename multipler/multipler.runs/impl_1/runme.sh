...
HD_PWD='E:/VHDL_project/multipler/multipler.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mul.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mul.tcl -notrace
